...
[Open SVG: internal architecture](./smdu_internal_architecture.svg)

[![internal architecture preview](./smdu_internal_architecture.png)](./smdu_internal_architecture.svg)
...
[Open SVG: terminal event lifecycle](./smdu_terminal_event_lifecycle.svg)

[![terminal event lifecycle preview](./smdu_terminal_event_lifecycle.png)](./smdu_terminal_event_lifecycle.svg)
...
[Open SVG: terminal protocol surface](./smdu_terminal_protocol_surface.svg)

[![terminal protocol surface preview](./smdu_terminal_protocol_surface.png)](./smdu_terminal_protocol_surface.svg)
...
[Open SVG: event constellation](./smdu_terminal_event_constellation.svg)

[![event constellation preview](./smdu_terminal_event_constellation.png)](./smdu_terminal_event_constellation.svg)
...
[Open SVG: escape sequence sketch map](./smdu_terminal_escape_sequence_map.svg)

[![escape sequence sketch map preview](./smdu_terminal_escape_sequence_map.png)](./smdu_terminal_escape_sequence_map.svg)
...
[Open SVG: ink event pipeline](./smdu_ink_event_pipeline.svg)

![ink event pipeline](./smdu_ink_event_pipeline.svg)
