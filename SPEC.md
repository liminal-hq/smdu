...
- **Incremental Results:** File list refreshes as directories finish, with a partial scan indicator.
...
4.  **Configuration (`src/config.ts`)**
    -   Uses `conf` to store settings (theme, units, file type colours, hidden files).
